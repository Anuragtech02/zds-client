	...
	<SectionLayout className="custom-section mt-10 pt-0 z-[1] relative text-left">
		<div class="text-gray-300 space-y-8 policy-content">
			...
			<div class="space-y-4">
				...
				<h3 class="text-xl font-semibold text-white mt-4">Automatically Collected Information</h3>
			...
			<div class="space-y-4">
				<h2 class="text-2xl font-bold text-white">5. Cookies and Tracking Technologies</h2>
				<p>
					We use cookies and similar tracking technologies to enhance your experience on our
					website. You can control cookie settings through your browser preferences. However,
					disabling cookies may limit some functionality of our website.
				</p>
			</div>

			<div class="space-y-4">
				<h2 class="text-2xl font-bold text-white">6. Data Security</h2>
				<p>
			...
			<div class="space-y-4">
				<h2 class="text-2xl font-bold text-white">7. Data Retention</h2>
				<p>
			...
			<div class="space-y-4">
				<h2 class="text-2xl font-bold text-white">8. Your Rights</h2>
			...
			<div class="space-y-4">
				<h2 class="text-2xl font-bold text-white">9. Third-Party Links</h2>
				<p>
			...
			<div class="space-y-4">
				<h2 class="text-2xl font-bold text-white">11. International Data Transfers</h2>
				<p>
			...
			<div class="space-y-4">
				<h2 class="text-2xl font-bold text-white">12. Changes to This Privacy Policy</h2>
				<p>
